...
# Moved to sim/kinematics.py so the AI does not have to import the keyboard
# module to find out how fast it may drive. Re-exported here because the
# human input path and several tools import them from this module.
from sim.kinematics import (max_forward_speed, max_yaw_rate,
                            twist_to_wheels_clamped)  # noqa: F401
